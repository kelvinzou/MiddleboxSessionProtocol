...
{   
    ...
    r->key.dst = in_aton(CL_ADDR);
    r->key.sport =5001;
    r->dst =  in_aton(M1_ADDR); // for EC2 has to be "172.31.3.163");
    ...
    r->key.src = in_aton(M1_ADDR); // for EC2 has to "172.31.3.163");
    r->key.dport = 5001;
    r->src =  in_aton (CL_ADDR);
    ...
    r->key.src = in_aton(M1_ADDR); // for ec2 has to be "172.31.3.163");
    r->key.dport =5002;
    r->src =  in_aton(CL_ADDR);
